...
```
git clone https://gitflic.ru/project/glazarev/yandex-password-backup.git
cd yandex-password-backup
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/glazarev/yandex-password-backup.git
git clone
